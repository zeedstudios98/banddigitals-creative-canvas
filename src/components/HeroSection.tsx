      ...
      <div className="container-custom relative z-10 flex flex-col items-center justify-center">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 reveal-item opacity-0 transform translate-y-10">
            <Button 
              className="bg-gradient-to-r from-[#4FD1C5] to-[#AC94F4] hover:opacity-90 text-white text-lg py-6 px-8 rounded-full animate-pulse-subtle"
            ...
            <Button 
              variant="outline" 
              className="border-2 text-lg py-6 px-8 rounded-full hover:scale-105 transition-transform duration-300"
